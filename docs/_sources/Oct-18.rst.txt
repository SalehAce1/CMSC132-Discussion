...
* Simplified linked list slides `from here. <http://www.cs.umd.edu/class/fall2021/cmsc132-030X/labs/Week8/SimplifiedListImplementation.pdf>`_

* LinkedList `Java documentation. <https://docs.oracle.com/en/java/javase/15/docs/api/java.base/java/util/LinkedList.html>`_

* Special iterator `Java documentation. <https://docs.oracle.com/en/java/javase/15/docs/api/java.base/java/util/ListIterator.html>`_
...
* Collection (interface): Collection of values (contains(), clear(), add(), size(), ...)
