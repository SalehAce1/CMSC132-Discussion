9/2 Intro/Using Eclipse
=======================

About me
^^^^^^^^
My name is Seyed Mohammad Ghaemi and I am sophomore majoring in computer science: machine learning.
You can contact me through email with sghaemi1@umd.edu.
...
For a more in-depth look, `check out the class site here <https://www.cs.umd.edu/class/fall2020/cmsc132/>`_.

Lectures and Discussions
~~~~~~~~~~~~~~~~~~~~~~~~
Lectures are prerecorded and take place on Mondays, Wednesdays, and Fridays. The class's main topics will be taught through lectures. 

Discussions (or labs) are live and take place on Mondays and Wednesdays. Discussions will mainly go over smaller topics and review content taught in lectures. 
...
the debug quiz on week 6 (more details on this later). 
